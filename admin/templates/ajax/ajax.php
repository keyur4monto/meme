...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <br />
      <form class="form-horizontal"  role="form" method="post" >
        <input type="hidden" class="form-control" name="del_temp" id="del_temp" value="<?=$del_id?>">
        <div class="form-group">
          <div class="col-lg-12">
...
<div class="modal-dialog">
  ...
  ?>
    <div class="modal-header">
      <button aria-hidden="true" data-dismiss="modal" class="close" type="button"> <i class="fa fa-times"></i></button>
      <h4 class="modal-title">Delete Templates</h4>
    </div>
    <div class="modal-body">
      <h5>Are You Sure Do You Want To Delete These Records ?</h5>
      <br />
      <form class="form-horizontal"  role="form" method="post" >
        <input type="hidden" class="form-control" name="del_temp_mul" id="del_temp_mul" value="<?=$del_mul?>">
        <div class="form-group">
          <div class="col-lg-12">
