...
<html lang="en">
  <head>
    ...
    <title>NorthIndian Template | <?php if(!empty($website_title)){echo $website_title;}else { echo 'Indianmeme.com';}?> </title>
    ...
    <div class="content white-bg pall-20 pb-40 sm-plr-10">
     ...
     <div class="row">
      ...
      <ul class="list-inline">
        ...
        <li class="mr-10"><a href="<?php echo $siteurl.'/northindian.php' ?>" id="northindian_memes" class="btn btn-sm search-meme">North Indian</a></li>
